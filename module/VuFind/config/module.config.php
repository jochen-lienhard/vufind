...
$config = [
    ...
    'controllers' => [
        'factories' => [
            ...
            'interlending' => 'VuFind\Controller\Factory::getInterlendingController',
            'interlendingrecord' => 'VuFind\Controller\Factory::getInterlendingrecordController',
        ...
        'plugin_managers' => [
            ...
            'recorddriver' => [
                ...
                'factories' => [
                    ...
                    'solrgvimarc' => 'VuFind\RecordDriver\Factory::getInterlending',
            ...
            'search_backend' => [
                'factories' => [
                    ...
                    'Interlending' => 'VuFind\Search\Factory\InterlendingBackendFactory',
...
$staticRoutes = [
    ...
    'Interlending/Advanced', 'Interlending/Home', 'Interlending/Search',
