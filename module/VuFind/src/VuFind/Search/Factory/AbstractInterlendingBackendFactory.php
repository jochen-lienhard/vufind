...
use VuFind\Search\Interlending\FilterFieldConversionListener;
use VuFind\Search\Interlending\HideFacetValueListener;
use VuFind\Search\Interlending\InjectHighlightingListener;
use VuFind\Search\Interlending\InjectConditionalFilterListener;
use VuFind\Search\Interlending\InjectSpellingListener;
use VuFind\Search\Interlending\MultiIndexListener;
use VuFind\Search\Interlending\V3\ErrorListener as LegacyErrorListener;
use VuFind\Search\Interlending\V4\ErrorListener;
use VuFind\Search\Interlending\DeduplicationListener;
use VuFind\Search\Interlending\HierarchicalFacetListener;

use VuFindSearch\Backend\BackendInterface;
use VuFindSearch\Backend\Interlending\LuceneSyntaxHelper;
use VuFindSearch\Backend\Interlending\QueryBuilder;
use VuFindSearch\Backend\Interlending\HandlerMap;
...
/**
 * Abstract factory for Interlending backends.
 *
 * @category VuFind
 * @package  Search
 * @author   David Maus <maus@hab.de>
 ...
 * @link     https://vufind.org Main Site
 */
abstract class AbstractInterlendingBackendFactory implements FactoryInterface
{
    /**
     * Logger.
     *
    ...
    /**
     * Get the Interlending Solr URL.
     *
     * @return string|array
     */
    protected function getSolrUrl()
    {
        $url = $this->config->get('config')->Interlending->url;
