...
use VuFind\Search\RDSProxy\InjectHighlightingListener;
use VuFind\Search\RDSProxy\InjectSpellingListener;
use VuFind\Search\RDSProxy\MultiIndexListener;
use VuFind\Search\RDSProxy\V3\ErrorListener as LegacyErrorListener;
use VuFind\Search\RDSProxy\V4\ErrorListener;

use VuFindSearch\Backend\BackendInterface;
use VuFindSearch\Backend\RDSProxy\LuceneSyntaxHelper;
use VuFindSearch\Backend\RDSProxy\QueryBuilder;
use VuFindSearch\Backend\RDSProxy\HandlerMap;
 ...
 * @link     http://vufind.org   Main Site
 */
abstract class AbstractRDSProxyBackendFactory implements FactoryInterface
{
    /**
     * Logger.
     *
    ...
    {
        return $this->config->get('config')->RDSProxy->url . '/' . $this->getSolrCore();
    }
