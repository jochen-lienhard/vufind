...
class RDSProxy extends SolrDefault
{
    ...
    {
        $thumb=$this->getLinks(array('category' => 'cover', 'type' => 'thumb'));
        if (isset($thumb[0]['url'])) { 
            return $thumb[0]['url']; 
        }
        return false;
    }
    ...
    {
        return (isset($this->fields['mediaicon']) ? substr($this->fields['mediaicon'], 3) : '');
    }
    ...
    */
    ...
    public function getCoinsOpenUrl() 
    {
        ...
        $formatter = new RDSToCOINS($this);
        $coins = $formatter->getRecord();
